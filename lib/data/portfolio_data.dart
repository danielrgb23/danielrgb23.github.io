...
/// A hobby shown as a "side quest" chip.
class SideQuest {
  final IconData icon;
  final String label;
  const SideQuest(this.icon, this.label);
}
...
List<Quest> get quests => [
      ...
      Quest(
        ...
        role:
            tr('Consultor e Engenheiro Mobile', 'Consultant & Mobile Engineer'),
...
List<SideQuest> get sideQuests => [
      SideQuest(Icons.sports_esports, tr('Jogos', 'Games')),
      SideQuest(Icons.sports_mma, tr('Boxe', 'Boxing')),
      SideQuest(Icons.live_tv, tr('Animes', 'Anime')),
      const SideQuest(Icons.psychology, 'Leetcode'),
      SideQuest(Icons.menu_book, tr('Estudos', 'Studying')),
    ];
...
List<Stage> get stages => [
      Stage(
        ...
        title: 'Servirologia',
        tags: [
          tr('Rede social', 'Social network'),
          'Flutter',
          tr('1M+ usuários', '1M+ users')
        ],
        description: tr(
      ...
      Stage(
        ...
        actions: const [
          LinkAction(
              'GitHub', 'https://github.com/danielrgb23/quiz_technical_app'),
        ],
      ),
      Stage(
